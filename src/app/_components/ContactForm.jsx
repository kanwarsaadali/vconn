      ...
      >
        {({
          ...
          <form
            ...
            style={{ fontFamily: "'Lato', sans-serif" }} // Apply Lato font globally
          >
            <div className="row">
              <div className="col-lg-6">
                <div className="mil-input-frame mil-dark-input mil-up mil-mb-30">
                  <label className="mil-upper">
                    <span>Full Name</span><span className="mil-required">*</span>
                  </label>
                  <input
                    type="text"
                    ...
                    onBlur={handleBlur}
                    value={values.name}
                    style={{ fontFamily: "'Lato', sans-serif" }} // Apply Lato font to input
                  />
                </div>
              </div>
              <div className="col-lg-6">
                <div className="mil-input-frame mil-dark-input mil-up mil-mb-30">
                  <label className="mil-upper">
                    <span>Email address</span><span className="mil-required">*</span>
                  </label>
                  <input
                    type="email"
              ...
              <div className="col-lg-6">
                <div className="mil-input-frame mil-dark-input mil-up mil-mb-30">
                  <label className="mil-upper">
                    <span>Phone</span><span className="mil-required">*</span>
                  </label>
                  <input
                    type="tel"
              ...
              <div className="col-lg-6">
                <div className="mil-input-frame mil-dark-input mil-up mil-mb-30">
                  <label className="mil-upper">
                    <span>Budget</span><span className="mil-required">*</span>
                  </label>
                  <input
                    type="text"
              ...
              <div className="col-lg-12">
                <div className="mil-input-frame mil-dark-input mil-up mil-mb-30">
                  <label className="mil-upper">
                    <span>Message</span><span className="mil-required">*</span>
                  </label>
                  <textarea
                    ...
                    style={{ fontFamily: "'Lato', sans-serif" }} // Apply Lato font to textarea
                  />
                </div>
              </div>
              <div className="col-lg-12">
                <div className="mil-checbox-frame mil-dark-input mil-up mil-mb-30">
                  ...
                  <label htmlFor="checkbox-1" className="mil-text-sm" style={{ fontFamily: "'Lato', sans-serif" }}>Accept the terms and conditions of personal data.</label>
                </div>
              </div>
              <div className="col-lg-12">
                <button
                  ...
                  style={{ fontFamily: "'Lato', sans-serif" }} // Apply Lato font to button
                >
                  Send Now
                </button>
              </div>
