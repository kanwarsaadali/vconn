...
const services = [
  {
    ...
    description:
      "Protect your business from cyber threats, malware, and hacking attempts with industry-leading security measures and real-time monitoring.",
  ...
  },
  {
    ...
    description:
      "Integrate security into every stage of your development lifecycle, ensuring robust protection, compliance, and efficiency in DevOps workflows.",
  ...
  },
  {
    ...
    description:
      "Optimize your IT infrastructure with our managed services, ensuring seamless performance, security, and proactive support for uninterrupted operations.",
  ...
  },
  {
    ...
    description:
      "Safeguard your critical data, applications, and systems with advanced encryption, access control, and compliance-driven security frameworks.",
