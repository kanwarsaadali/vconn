...
//   const fontFamilyStyle = { fontFamily: 'Arial, sans-serif' }; // Define the font family style

//   return (
//     <>
//       <section id="projectSection" className="py-5" style={{ marginTop: "-50px", ...fontFamilyStyle }}>
//         <div className="container-fluid py-5">
//           <div className="d-flex justify-content-center">
//             <div className="mil-center mil-mb-90">
//               <span className="mil-suptitle mil-upper mil-up mil-mb-30" style={{ color: "black", fontSize: "clamp(1.5rem, 2vw, 2.5rem)", ...fontFamilyStyle }}>
//                 Our Services
//               </span>
//               <h2 className="mil-upper mil-up mil-mb-30" style={{ color: "black", fontSize: "clamp(2rem, 4vw, 3rem)", ...fontFamilyStyle }}>
//                 What We Do
//               </h2>
//             </div>
//           </div>
//           <div className="row" style={{ marginTop: "-50px" }}>
//             {projects?.map((item, item_key) => (
//               <div className="col-md-6 col-lg-3 px-4 mb-4" key={`projects-row-${item_key}`} style={fontFamilyStyle}>
//                 <Link
//                   href={`/projects/${item.id}`}
//                   key={`projects-item-${item_key}`}
//                   className={
//                     item == null
...
//                   }
//                 >
//                   <h4 className="text-center" style={{ fontSize: "clamp(1.5rem, 2.5vw, 2rem)", marginTop: "-40px", ...fontFamilyStyle }}>
//                     {item.title}
//                   </h4>
//                   <h5 className="mil-mb-20 mil-mb-201" style={{ color: "black", fontSize: "clamp(1.2rem, 2vw, 1.8rem)", ...fontFamilyStyle }}>
//                     {item.describion}
//                   </h5>
//                   <img className="img-fluid img1" src={item.image} alt={item.title} />
//                   <div className="mil-project-descr p-0 m-0">
//                     <p style={{ fontSize: "clamp(0.9rem, 1.5vw, 1.2rem)", ...fontFamilyStyle }}>{item.short}</p>
//                     <h4 style={{ fontSize: "clamp(1rem, 1.8vw, 1.5rem)", color: "black", marginTop: "180px", ...fontFamilyStyle }}>
//                       {item.describtion1}
//                     </h4>
//                     <span style={{ width: "100%" }} className="w-100">
//                       <img style={{ width: "100%" }} className="img-fluid img2 w-100" src={item.image1} />
//                       <span className="mil-link mil-light mil-upper">
//                         Expand <span className="mil-arrow"><img src="img/icons/1.svg" className="img3" alt="arrow" /></span>
//                       </span>
//                     </span>
...
const cardData = [
  ...
  {
    id: 3,
    image: "/images/explore-pnw.jpg",
    title: "Explore the PNW",
    description:
      "Explore the majestic beauty of the Pacific Northwest from the air.",
  },
  {
    id: 4,
    image: "/images/custom-tours.jpg",
    title: "Custom Tours",
    description:
