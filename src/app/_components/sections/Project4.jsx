...
const Project4 = () => {
  const items = [
    { icon: "/img/icons/SERVICE 1_1.png", title: "Cloud Management", description: "Managing cloud infrastructure." },
    { icon: "/img/icons/SERVICE 1_2.png", title: "Network Management", description: "Monitoring and maintaining network health." },
    { icon: "/img/icons/SERVICE 1_3.png", title: "Application Performance Monitoring (APM)", description: "Monitoring application performance." },
    { icon: "/img/icons/SERVICE 1_4.png", title: "Backup & Disaster Recovery", description: "Secure data backup and disaster recovery." },
    { icon: "/img/icons/SERVICE 1_5.png", title: "Managed Endpoint Security", description: "Remote endpoint security management." },
    { icon: "/img/icons/SERVICE 1_6.png", title: "Help Desk & Support", description: "End-user support and troubleshooting." },
