...
const projects = [
  { icon: "/img/icons/project4.png", title: "Proactive Threat Intelligence and SOC Services", description: "Stay secure with 24/7 SOC services and real-time threat intelligence to prevent cyber attacks." },
  { icon: "/img/icons/project5.png", title: "Next-Level Vulnerability Assessment & Penetration Testing", description: "Fix vulnerabilities & strengthen your defenses with actionable insights.", extra: "Our experts simulate real-world attacks to expose weak points and enhance your security posture." },
  ...
  { icon: "/img/icons/project1.png", title: "Automated CI/CD Pipelines for Faster, Safer Deployments", description: "Speed up secured software delivery with automated CI/CD pipelines for smooth deployments.", extra: "By automating testing and deployment, we help you release features faster with improved reliability." },
  { icon: "/img/icons/project2.png", title: "Kubernetes-Powered Application Modernization", description: "Scale with Kubernetes-powered containerization delivering agility for your applications.", extra: "Our container-based approach ensures high availability, portability, and resilience for modern applications." },
