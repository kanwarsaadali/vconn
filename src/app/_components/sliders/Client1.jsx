...
import Data from "@data/sliders/clientgreen";

const ClientSlider1 = ({ bgStyle }) => {
  return (
    <>
      {/* Partners Section */}
      <div
        className={`mil-${bgStyle}-bg mil-partners mil-relative`}
        style={{backgroundColor: "rgb(12, 20, 31)", marginTop:"-10px"}}
      >
        <div className="container mil-p-60">
          <div className="mil-background-grid mil-softened" />
          <div className="row">
            <div className="col-12">
              <div className="mil-center mil-mb-60" style={{  color: "rgb(12, 20, 31)"}}>
                <span
                  className="mil-suptitle-withourgreen mil-up mil-mb-30"
                  dangerouslySetInnerHTML={{ __html: advantage.subtitle }}
                  style={{ color: "rgb(188, 255, 0)", fontSize: "2.5rem", marginTop:"20px", fontFamily:"'Lato', sans-serif" }}
                />
                {/* <h2
